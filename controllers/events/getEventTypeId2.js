...
function getEventTypebyId2(req, res) {
    ...
    xhr.onload = function() {
        ...
        if ((jsonResponse.typeEventData !== undefined) && (jsonResponse.typeEventData.length != 0)) {
            ...
            if (jsonResponse.code == 200) {
                //console.log(id);
                res.render('events/eventTypeId2', {
            ...
            res.render('events/eventTypeId2null', {}); // render the view and send to the view the response array
        }
    };
...
module.exports = getEventTypebyId2;